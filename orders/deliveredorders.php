<?php
  ...
  $name=$_SESSION['username'];
   $query="select r.cid, r1.name,r1.mobile_no,p.product_name,p.pid,p.brand_name,p.category_name,p.product_price,r.confirmation,r.delevery,r.Date from products p join cart r on (p.pid=r.pid) join registration r1 on (r1.name=r.user_name)  where r.delevery='yes' and confirmation='yes'";
...
<div class="container" >
  <div class="py-3"></div>
  <h2 align="center" class="text-white bg-dark">Order History</h2>        
  <div class="container">           
